...
# Table of Contents
  ...
  3. [Create Groups for MLZ RBAC](#3-create-mlz-rbac-security-groups)
  4. [Create Named Admin Accounts](#4-create-named-administrator-accounts)
...
### Log in to the Azure Portal and license the first Global Administrator
